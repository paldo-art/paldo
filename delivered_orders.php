...
$sql = "
    SELECT o.orderID, o.total, o.order_date, o.status, o.delivery_date, c.customername, c.address, s.shipperName, r.name as riderName
    FROM orders o
...
<head>
    ...
    <title>Delivered Orders - Admin Dashboard</title>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="dashboard-header">
                <h2 class="dashboard-title">Delivered Orders</h2>
                <div class="user-info">
